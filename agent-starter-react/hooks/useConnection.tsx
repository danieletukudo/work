...
export function ConnectionProvider({ appConfig, children }: ConnectionProviderProps) {
  ...
  const tokenSource = useMemo(() => {
    ...
    const PYTHON_API_ENDPOINT = process.env.NEXT_PUBLIC_CONN_DETAILS_ENDPOINT ||  'https://heuristically-unpreventive-dimple.ngrok-free.dev/api/connection-details' || 'http://0.0.0.0:5001/api/connection-details';
