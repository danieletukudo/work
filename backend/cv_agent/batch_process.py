...
from cv_agent.donwload_and_process_cv import download_cvs, process_cv_folder
from cv_agent.loggerfile import setup_logging
from typing import Dict

# setup logging
logger = setup_logging("batch_process")
...
async def _process_single_batch(
    ...
    try:
        ...
        downloaded_candidate_details, failed_links = download_cvs(candidate_details_batch, batch_folder_path) # Pass the batch_folder_path
...
async def process_all_batches(
    ...
    try:
        ...
        db.update_job_status(str(job_id), total_candidates, 0, "complete", source="auto")
